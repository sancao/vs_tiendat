      ...
      <div class="col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="form-nhap-so" class="form-input">
                        <div class="form-row">
                            <div class="form-group">
                                <label for="inputForSocui">Số cùi</label>
                                <input class="form-control" type="text" placeholder="Số cùi"
                                id="inputForSocui"
                                v-model="nhapso.socui" maxlength="2"
                                v-on:input="$v.nhapso.socui.$touch">
                                <div v-if="$v.$error">
                                    <p class="error" v-if="!$v.nhapso.socui.required">Nhập số cùi.</p>
                                    <p class="error" v-else-if="!$v.nhapso.socui.numeric">Số không hợp lệ.</p>
                                    <p class="error" v-else-if="!$v.nhapso.socui.between">Số trong khoản 0->99.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                id="inputForTuso"
                                v-model="nhapso.tuso" maxlength="4"
                                ...
                                <div v-if="$v.$error">
                                    ...
                                    <p class="error" v-else-if="!$v.nhapso.tuso.between">Số trong khoản 0->9999.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                id="inputForDenso"
                                v-model="nhapso.denso" maxlength="4"
                                ...
                                <div v-if="$v.$error">
                                    ...
                                    <p class="error" v-else-if="!$v.nhapso.denso.between">Số trong khoản 0->9999.</p>
                                    <p class="error" v-else-if="!$v.nhapso.denso.number_greater">Số này phải lớn hơn số ở ô Từ Số.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="inputngaynhap">Ngày nhập</label>
                                <input class="form-control" type="text" v-model="nhapso.ngaynhap" id="inputngaynhap" readonly/>
                            </div>
                        </div>
...
var axios = require("axios");
  export default {
    ...
    data: function () {
      return {
        ...
        nhapso:{
            ...
            menhgia:"",
            tongtien:"",
            ngaynhap:moment().format('YYYY-MM-DD hh:mm:ss a'),
            index:-1
        },
        dailies:[],
        filterValue: '',
        ...
        sortOrders: [],
        nhapsos: [],
        columns: ['hinhanh','nguoinhap','socui','tuso','denso','menhgia','tongtien','daily','ngaynhap','thaotac'],
        pagination: {
            total: 0, 
            per_page: 2,
            from: 1, 
    ...
    computed: {
        tongtien_recall(){
            if(this.nhapso.menhgia>0 && this.nhapso.denso>0 && this.nhapso.tuso>0){
                this.nhapso.tongtien= (this.nhapso.denso-this.nhapso.tuso)*this.nhapso.menhgia
            }

            return this.nhapso.tongtien
        },
    ...
    methods: {
        changeMenhGia(){
            if(this.nhapso.menhgia>0){
                this.nhapso.tongtien=(this.nhapso.denso-this.nhapso.tuso)*this.nhapso.menhgia
            }
        },
        updateNhapso(so,index){
            debugger
            this.nhapso.id=so.id
            this.nhapso.socui=so.socui
            this.nhapso.tuso=so.tuso
            this.nhapso.denso=so.denso
            this.nhapso.daily_id=so.daily_id
            this.nhapso.menhgia=so.menhgia
            this.nhapso.tongtien=so.tongtien
            this.nhapso.ngaynhap=so.created_at
            ...
            if (!app.$v.nhapso.$invalid) 
            {
                ...
                .then(function (resp) {
                    ...
                    if(app.nhapso.id<=0){
                        ...
                        let temp=app.nhapsos[app.nhapso.index]
                        app.nhapso.ngaynhap=temp.created_at
                        app.nhapso.id=temp.id
                        app.nhapso.socui=temp.socui
                        app.nhapso.denso=temp.denso
                        app.nhapso.daily_id=temp.daily_id
                        app.nhapso.menhgia=temp.menhgia
                        app.nhapso.tongtien=temp.tongtien
                        app.nhapso.menhgia=temp.menhgia
                    }
        ...
        clear() {
            this.nhapso={daily_id:"",id:0,tuso:"",denso:"",ngaynhap:moment().format('YYYY-MM-DD hh:mm:ss a'),menhgia:""}
        },
